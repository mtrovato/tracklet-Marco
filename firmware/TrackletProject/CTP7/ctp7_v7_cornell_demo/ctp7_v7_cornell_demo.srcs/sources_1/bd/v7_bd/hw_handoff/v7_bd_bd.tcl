...
proc create_root_design { parentCell } {
  ...
  set BRAM_CTRL_CAP_RAM_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_CTRL_CAP_RAM_0 ]
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_CTRL_CAP_RAM_0
  set BRAM_CTRL_CAP_RAM_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_CTRL_CAP_RAM_1 ]
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_CTRL_CAP_RAM_1
  set BRAM_CTRL_DRP [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_CTRL_DRP ]
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_CTRL_DRP
  set BRAM_CTRL_GTH_REG_FILE [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_CTRL_GTH_REG_FILE ]
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_CTRL_GTH_REG_FILE
  set BRAM_CTRL_REG_FILE [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_CTRL_REG_FILE ]
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_CTRL_REG_FILE
  set clk_200_diff_in [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 clk_200_diff_in ]
  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $clk_200_diff_in
  ...
  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $axi_c2c_zynq_to_v7_clk
  ...
  set clk_out2_100mhz [ create_bd_port -dir O -type clk clk_out2_100mhz ]
  set clk_out3_50mhz [ create_bd_port -dir O -type clk clk_out3_50mhz ]

  # Create instance: axi_bram_ctrl_0, and set properties
  set axi_bram_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_0 ]
  set_property -dict [ list CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_0

  # Create instance: axi_bram_ctrl_cap_ram_0, and set properties
  set axi_bram_ctrl_cap_ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_cap_ram_0 ]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_cap_ram_0

  # Create instance: axi_bram_ctrl_cap_ram_1, and set properties
  set axi_bram_ctrl_cap_ram_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_cap_ram_1 ]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_cap_ram_1
  ...
  set_property -dict [ list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_drp
  ...
  set_property -dict [ list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_gth_reg_file
  ...
  set_property -dict [ list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1}  ] $axi_bram_ctrl_reg_file
  ...
  set_property -dict [ list CONFIG.C_AURORA_WIDTH {64} CONFIG.C_AXI_ID_WIDTH {1} CONFIG.C_AXI_WUSER_WIDTH {1} CONFIG.C_COMMON_CLK {0} CONFIG.C_INCLUDE_AXILITE {2} CONFIG.C_INTERFACE_MODE {1} CONFIG.C_MASTER_FPGA {0} CONFIG.C_SELECTIO_PHY_CLK {200}  ] $axi_chip2chip_0
...
CONFIG.CLKOUT1_DRIVES {BUFGCE} CONFIG.CLKOUT1_JITTER {98.146} \
CONFIG.CLKOUT1_PHASE_ERROR {89.971} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {200} \
CONFIG.CLKOUT2_DRIVES {BUFGCE} CONFIG.CLKOUT2_JITTER {112.316} \
CONFIG.CLKOUT2_PHASE_ERROR {89.971} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100} \
CONFIG.CLKOUT2_USED {true} CONFIG.CLKOUT3_DRIVES {BUFGCE} \
CONFIG.CLKOUT3_JITTER {129.198} CONFIG.CLKOUT3_PHASE_ERROR {89.971} \
CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {50} CONFIG.CLKOUT3_USED {true} \
CONFIG.CLKOUT4_JITTER {89.608} CONFIG.CLKOUT4_PHASE_ERROR {82.655} \
CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {240} CONFIG.CLKOUT4_USED {false} \
CONFIG.CLKOUT5_JITTER {127.032} CONFIG.CLKOUT5_PHASE_ERROR {82.655} \
CONFIG.CLKOUT5_USED {false} CONFIG.MMCM_CLKFBOUT_MULT_F {5.000} \
CONFIG.MMCM_CLKOUT0_DIVIDE_F {5.000} CONFIG.MMCM_CLKOUT1_DIVIDE {10} \
CONFIG.MMCM_CLKOUT2_DIVIDE {20} CONFIG.MMCM_CLKOUT3_DIVIDE {1} \
CONFIG.NUM_OUT_CLKS {3} CONFIG.PRIM_IN_FREQ {200} \
CONFIG.PRIM_SOURCE {Differential_clock_capable_pin} CONFIG.USE_DYN_RECONFIG {false} \
CONFIG.USE_PHASE_ALIGNMENT {false} CONFIG.USE_RESET {false} \
CONFIG.USE_SAFE_CLOCK_STARTUP {true}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.ADC_CONVERSION_RATE {962} CONFIG.DCLK_FREQUENCY {50} CONFIG.INTERFACE_SELECTION {Enable_AXI} CONFIG.OT_ALARM {false} CONFIG.USER_TEMP_ALARM {false} CONFIG.VCCAUX_ALARM {false} CONFIG.VCCINT_ALARM {false}  ] $xadc_wiz_0

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_chip2chip_0/m_axi_lite] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA1 [get_bd_intf_ports BRAM_CTRL_CAP_RAM_0] [get_bd_intf_pins axi_bram_ctrl_cap_ram_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA2 [get_bd_intf_ports BRAM_CTRL_CAP_RAM_1] [get_bd_intf_pins axi_bram_ctrl_cap_ram_1/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_bram_ctrl_gth_reg_file/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_bram_ctrl_reg_file/S_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_bram_ctrl_cap_ram_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_bram_ctrl_cap_ram_1/S_AXI] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_bram_ctrl_drp/S_AXI] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_out2_100mhz] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports clk_out3_50mhz] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_cap_ram_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_cap_ram_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_drp/s_axi_aclk] [get_bd_pins axi_bram_ctrl_gth_reg_file/s_axi_aclk] [get_bd_pins axi_bram_ctrl_reg_file/s_axi_aclk] [get_bd_pins axi_chip2chip_0/m_aclk] [get_bd_pins axi_chip2chip_0/m_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  create_bd_addr_seg -range 0x20000 -offset 0x61000000 [get_bd_addr_spaces axi_chip2chip_0/MAXI-Lite] [get_bd_addr_segs axi_bram_ctrl_cap_ram_0/S_AXI/Mem0] SEG_axi_bram_ctrl_cap_ram_0_Mem0
  create_bd_addr_seg -range 0x20000 -offset 0x61020000 [get_bd_addr_spaces axi_chip2chip_0/MAXI-Lite] [get_bd_addr_segs axi_bram_ctrl_cap_ram_1/S_AXI/Mem0] SEG_axi_bram_ctrl_cap_ram_1_Mem0
