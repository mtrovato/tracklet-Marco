...
#SFP5
#FMC1_HPC_DP6_C2M_P(N) in VC707 manual. FMC_SFP5_TX_P(N) in this project
set_property PACKAGE_PIN G2 [get_ports FMC_SFP5_TX_P]
set_property PACKAGE_PIN G1 [get_ports FMC_SFP5_TX_N]
#FMC1_HPC_DP6_M2C_P(N) in VC707 manual. FMC_SFP5_RX_P(N) in this project
set_property PACKAGE_PIN F8 [get_ports FMC_SFP5_RX_P]
set_property PACKAGE_PIN F7 [get_ports FMC_SFP5_RX_N]
#FMC1_HPC_LA29_N in VC707 manual. FMC_SFP5_TX_DISABLE in this project
set_property PACKAGE_PIN T30 [get_ports FMC_SFP5_TX_DISABLE]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP5_TX_DISABLE]
#FMC1_HPC_LA27_P in VC707 manual. FMC_SFP5_LOS in this project
set_property PACKAGE_PIN J31 [get_ports FMC_SFP5_LOS]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP5_LOS]
#FMC1_HPC_LA27_N in VC707 manual. FMC_SFP5_RS in this project
set_property PACKAGE_PIN H31 [get_ports FMC_SFP5_RS]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP5_RS]

#SFP6
#FMC1_HPC_DP5_C2M_P(N) in VC707 manual. FMC_SFP6_TX_P(N) in this project
set_property PACKAGE_PIN H4 [get_ports FMC_SFP6_TX_P]
set_property PACKAGE_PIN H3 [get_ports FMC_SFP6_TX_N]
#FMC1_HPC_DP5_M2C_P(N) in VC707 manual. FMC_SFP6_RX_P(N) in this project
set_property PACKAGE_PIN G6 [get_ports FMC_SFP6_RX_P]
set_property PACKAGE_PIN G5 [get_ports FMC_SFP6_RX_N]
#FMC1_HPC_LA26_P in VC707 manual. FMC_SFP6_TX_DISABLE in this project
set_property PACKAGE_PIN J30 [get_ports FMC_SFP6_TX_DISABLE]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP6_TX_DISABLE]
#FMC1_HPC_LA23_N in VC707 manual. FMC_SFP6_LOS in this project
set_property PACKAGE_PIN N31 [get_ports FMC_SFP6_LOS]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP6_LOS]
#FMC1_HPC_LA24_P in VC707 manual. FMC_SFP6_RS in this project
set_property PACKAGE_PIN R30 [get_ports FMC_SFP6_RS]
set_property IOSTANDARD LVCMOS18 [get_ports FMC_SFP6_RS]
