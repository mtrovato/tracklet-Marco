...
module Aurora_Channel_1(
    ...
    input wire gt_qpllclk_quad,             // input
    input wire gt_qpllrefclk_quad,          // input
    output wire gt0_qpllreset,               // output
    //Dynamical Reconfiguration Ports
    ...
    input wire [8:0] drpaddr_in_lane1,
    input wire drpen_in_lane1,
    input wire [15:0] drpdi_in_lane1,
    input wire drpwe_in_lane1,
    output wire drprdy_out_lane1,
    output wire [15:0] drpdo_out_lane1,    
...
//    output wire link_reset_out               // output, to IPbus I/O   
    ...
    aurora_8b10b_1 aurora_8b10b_1 (
        ...
        .drprdy_out(drprdy_out),         // output [15:0], unused
        .drpdo_out(drpdo_out),           // output, unused
        .drpaddr_in_lane1(drpaddr_in_lane1),                // input [8:0], tied off
        .drpen_in_lane1(drpen_in_lane1),                    // input, tied off
        .drpdi_in_lane1(drpdi_in_lane1),                    // input [15:0], tied off
        .drpwe_in_lane1(drpwe_in_lane1),                    // input, tied off
        .drprdy_out_lane1(drprdy_out_lane1),         // output [15:0], unused
        .drpdo_out_lane1(drpdo_out_lane1),           // output, unused        
        // QPLL Ports
        .gt0_qplllock_in(gt0_qplllock),               // input
        .gt0_qpllrefclklost_in(gt0_qpllrefclklost),   // input
        .gt_qpllrefclk_quad6_in(gt_qpllrefclk_quad), // input
        .gt_qpllclk_quad6_in(gt_qpllclk_quad),       // input
    ...
    aurora_io_block io_block(
      ...
      .lane_up(lane_up[0:1]),                      // input, to IPbus I/O
      .pll_not_locked(pll_not_locked),        // input, from channel clock module
