...
module aurora_io_block(
  ...
  always @ (posedge io_clk) begin
    ...
    live_status_reg[2:1] <=  lane_up[0:1];             // 
    live_status_reg[3] <= frame_err;                   // 
    live_status_reg[4] <=  hard_err;                   // 
    live_status_reg[5] <=  soft_err;                   // 
    live_status_reg[6] <=  pll_not_locked;             // 
    live_status_reg[7] <=  tx_resetdone_out;           // 
    live_status_reg[8] <=  rx_resetdone_out;           // 
    live_status_reg[9] <=  link_reset_out;             // 
    live_status_reg[31:10] <=  23'b0;                   // 
  end
