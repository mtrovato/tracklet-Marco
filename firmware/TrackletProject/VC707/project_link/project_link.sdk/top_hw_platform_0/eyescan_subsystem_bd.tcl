...
proc create_hier_cell_DRP_Bridge_hier { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_aclk_1 [get_bd_pins AXI_aclk] [get_bd_pins drp_bridge_0/AXI_aclk] [get_bd_pins drp_bridge_1/AXI_aclk] [get_bd_pins drp_bridge_2/AXI_aclk] [get_bd_pins drp_bridge_3/AXI_aclk]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins AXI_aresetn] [get_bd_pins drp_bridge_0/AXI_aresetn] [get_bd_pins drp_bridge_1/AXI_aresetn] [get_bd_pins drp_bridge_2/AXI_aresetn] [get_bd_pins drp_bridge_3/AXI_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {5} CONFIG.NUM_SI {2} CONFIG.STRATEGY {1}  ] $microblaze_1_axi_periph

  # Create interface connections
  connect_bd_intf_net -intf_net AXI0_1 [get_bd_intf_pins DRP_Bridge_hier/AXI0] [get_bd_intf_pins microblaze_1_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net AXI1_1 [get_bd_intf_pins DRP_Bridge_hier/AXI1] [get_bd_intf_pins microblaze_1_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net AXI2_1 [get_bd_intf_pins DRP_Bridge_hier/AXI2] [get_bd_intf_pins microblaze_1_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net AXI3_1 [get_bd_intf_pins DRP_Bridge_hier/AXI3] [get_bd_intf_pins microblaze_1_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M04_AXI [get_bd_intf_pins mb_ps/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M04_AXI]

  # Create port connections
  connect_bd_net -net axi_aclk_1 [get_bd_ports AXI_aclk] [get_bd_pins DRP_Bridge_hier/AXI_aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins mb_ps/S_AXI_ACLK] [get_bd_pins microblaze_1_axi_periph/ACLK] [get_bd_pins microblaze_1_axi_periph/M00_ACLK] [get_bd_pins microblaze_1_axi_periph/M01_ACLK] [get_bd_pins microblaze_1_axi_periph/M02_ACLK] [get_bd_pins microblaze_1_axi_periph/M03_ACLK] [get_bd_pins microblaze_1_axi_periph/M04_ACLK] [get_bd_pins microblaze_1_axi_periph/S00_ACLK] [get_bd_pins microblaze_1_axi_periph/S01_ACLK]
  connect_bd_net -net m07_aresetn_1 [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins mb_ps/interconnect_aresetn] [get_bd_pins microblaze_1_axi_periph/ARESETN] [get_bd_pins microblaze_1_axi_periph/M00_ARESETN] [get_bd_pins microblaze_1_axi_periph/M01_ARESETN] [get_bd_pins microblaze_1_axi_periph/M02_ARESETN] [get_bd_pins microblaze_1_axi_periph/M03_ARESETN] [get_bd_pins microblaze_1_axi_periph/M04_ARESETN] [get_bd_pins microblaze_1_axi_periph/S00_ARESETN] [get_bd_pins microblaze_1_axi_periph/S01_ARESETN]
